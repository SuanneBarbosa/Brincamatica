...
void _updateLayoutParameters() {
  ...
  if (!_layoutInitialized || _currentIconSizeSetting > _maxAllowedIconSize) {
    debugPrint("Adjusting icon size from $_currentIconSizeSetting to max allowed $_maxAllowedIconSize");
  ...
  const double gridTotalHeightPercentage = 0.65;
